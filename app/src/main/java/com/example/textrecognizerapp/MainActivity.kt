...
import com.example.textrecognizerapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        binding.penImage.setOnClickListener {
            // Launch the NotesActivity when the pen button is clicked
